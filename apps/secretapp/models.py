...
class SecretManager(models.Manager):
    def basic_validator(self, postData):
        ...
        if len(postData['content']) < 5:
            errors["content"] = "content cannot be less than 5 characters"
        if len(postData['content']) > 200:
            errors["content"] = "content cannot be greater than 200 characters"
        return errors
...
class Secret(models.Model):
    ...
    likes=models.ManyToManyField(User, related_name='postid')
